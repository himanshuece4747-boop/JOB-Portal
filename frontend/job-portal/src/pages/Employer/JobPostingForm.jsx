...
const JobPostingForm = () => {
  ...
  try {
    const response  = jobId
      ? await axiosInstance.put(API_PATHS.JOBS.UPDATE_JOB , jobPayload)
          ...
          <div className='bg-white shadow-xl rounded-2xl p-6'>
            <div className='flex items-center justify-between mb-8'>
              ...
              <div className='flex items-center space-x-2'>
                ...
                >
                  <Eye className='h-4 w-4 transition-transform group-hover:-translate' />
                  <span>Preview</span>
                </button>
              </div>
            ...
            <div className='space-y-6'>
              ...
              <InputField
                label='Job Title'
                id= 'jobTitle'
                placeholder='e.g. Senior Frontened Engineer'
            ...
            <TextareaField
                ...
                helperText = "Include key responsibilities, dat-to-day tasks and what makes this role exciting."
                required
            />
            ...
            <TextareaField
                ...
                helperText = "Include required skills, experience and qualifications."
                required
            />
                ...
                <div className=' grid grid-cols-3 gap-3'>
                    <div className="relative">
                        ...
                        <input
                            ...
                            className={`w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-lg text-base focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 focus:border-blue-500 transition-colors duration-200 `}
                        />
                    </div>
                    <div className='relative'>
                        <div className='absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none'>
