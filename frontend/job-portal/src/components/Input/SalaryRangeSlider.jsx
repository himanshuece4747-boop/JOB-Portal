...
const SalaryRangeSlider = ({filters, handleFilterChange}) => {
    ...
    const [maxSalary, setMaxSalary] = useState(filters?.maxSlary || 0);
  return (
        ...
        <div className='grid grid-cols-2 gap-4'>
            ...
            <div>
                ...
                <input 
                    ...
                    min="0"
                    step="1000"
                    className='w-full px-3 py-2 border border-gray-300 rounded-md focus:border-blue-300 focus:ring focus:ring:ring-blue-200 focus:ring-opacity-50'
                    value={maxSalary || ""}
