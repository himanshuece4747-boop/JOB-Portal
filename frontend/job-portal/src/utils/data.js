...
export const jobSeekersFeatures = [
    {
        ...
        description:
            "AI-powered algorithm matches you with relevant opportunities based on your skills and perferences."
    },
    {
        icon: FileText,
        title: "Resume Building",
        description:
            "Create professionals resume with our intuitive builder and template designed by experts"
    },
     {
        icon: MessageSquare,
    ...
    },
    {
        ...
        description:
            "Showcase your abilities with varied skill test and earn bages that employers trust."
    },
];
